<x-app-layout>
    ...
    <div class="grid grid-cols-4 gap-4 my-8">
        ...
        <div class="max-w-sm p-6 bg-white border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700">
            ...
            <p class="mb-3 font-normal text-gray-700 dark:text-gray-400">Plannification mensuelles des differentes activités se deroulant au sein de l'Academy Digital</p>
        ...
        <div class="max-w-sm p-6 bg-white border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700">
            ...
            <p class="mb-3 font-normal text-gray-700 dark:text-gray-400">Rapport hebdomadaire sur les differentes activités se deroulant au sein de l'Orange Digital Center</p>
