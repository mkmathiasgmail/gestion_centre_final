...
<body>
    <div class="flex items-center justify-center min-h-screen bg-cover bg-center bg-no-repeat  backdrop-blur-md"
        ...
        <div class="max-w-md mx-auto text-center bg-white bg-opacity-90 p-8 rounded-lg shadow-lg">
            <div class="text-9xl font-bold text-orange-500 mb-4">419</div>
            <h1 class="text-4xl font-bold text-gray-800 mb-6">Page Expired</h1>
            <p class="text-lg text-gray-600 mb-8">Oups ! Votre session a pris un petit voyage. Nous avons perdu son trace. Revenez un peu plus tard !</p>
