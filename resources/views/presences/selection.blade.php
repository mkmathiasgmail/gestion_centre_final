    ...
    <div class="mt-20">
        <form class="max-w-sm mx-auto" action="{{ route('filtrer') }}" method="post" id="verifyuserForm">
            ...
            @if (session('error'))
                ...
                <p><a class="text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 me-2 mb-2 dark:bg-blue-600 dark:hover:bg-blue-700 focus:outline-none dark:focus:ring-blue-800"
                        href="https://www.orangedigitalcenters.com/signUp">Créer un compte</a></p>
            @endif
    </div>
    </form>
