@props(['events'])
<!-- Modal pour l'affichage de la liste d'activites candidatees par le user -->
<div id="candidatures-modal" tabindex="-1" aria-hidden="true"
        ...
        <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
            ...
            <div class="flex items-center justify-between p-4 md:p-5 border-b rounded-t dark:border-gray-600">
                ...
                <button type="button"
                    ...
                    data-modal-toggle="candidatures-modal">
                        ...
                        <li>
                            ...
                            <label for="job-1"
                                ...
                                <div class="block">
                                    ...
                                    <div class="w-full text-gray-500 dark:text-gray-400">{{ $item->title }}</div>
                                </div>
