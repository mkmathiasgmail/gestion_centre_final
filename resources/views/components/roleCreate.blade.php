{{-- <div>
    {{-- <form action="{{ route('roles.store') }}" method="POST" class="mb-6">
            ...
            <div class="flex items-center">
                <input type="text" name="role_name" placeholder="Nom du rôle" required class="p-2 mr-2 border rounded-md">
            </div>
            @error('role_name')
        ...
        <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
            ...
            <div class="p-4 md:p-5">
                <form class="space-y-4" action="{{ route('role.store') }}" method="POST">
                    ...
                    <button type="submit"
                        class="w-full py-2 px-3 inline-flex items-center gap-x-2 text-sm font-medium rounded-lg border border-transparent bg-[#FF7322] text-white hover:bg-[#FF6822] focus:outline-none focus:bg-[#FF6822] disabled:opacity-50 disabled:pointer-events-none">
