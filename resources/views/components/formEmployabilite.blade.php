        ...
        <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
            <div class="relative bg-white bg-center bg-cover rounded-lg shadow dark:bg-gray-700">
                ...
                <div class="flex items-center justify-between p-4 border-b rounded-t md:p-5 dark:border-gray-600"
                    style="background-image: url('/img/bug.gif');">
                    ...
                    <button type="button"
                        ...
                        data-modal-toggle="crud-modal1" id="resetButton1">
                    ...
                    <div class="grid grid-cols-2 gap-4 mb-4">
                        ...
                        <div class="col-span-2">
                            ...
                            <input name="first_name" id="first_name"
                                ...
                                placeholder="🔤 veuillez saisir votre prenom" type="text" autocomplete="off" required>
                                    ...
                                    text-gray-900 bg-gray-50 rounded-lg border border-gray-300 focus:ring-blue-500
                                     focus:border-blue-500 dark:bg-gray-600 dark:border-gray-500 dark:placeholder-gray-400
                                      dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                                            placeholder="💼 Veuillez saisir votre poste" autocomplete="off" required>
                        ...
                        {{--insererbtn--}}
                        <button type="submit"
                            class="text-white inline-flex items-center bg-slate-700 hover:bg-slate-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">
