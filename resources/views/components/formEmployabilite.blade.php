            ...
            <div class="relative bg-white bg-center bg-cover rounded-lg shadow dark:bg-gray-700">
                ...
                <form class="p-4 md:p-5" action="{{ route('employabilites.store') }}" method="post">
                    ...
                    <div class="grid grid-cols-2 gap-4 mb-4">
                        ...
                        {{--insererbtn--}}
                        <button type="submit"
                            class="text-white inline-flex items-center bg-green-700 hover:bg-slate-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">
