        ...
        <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
            ...
            <form class="p-4 md:p-5" action="{{route('userlocal')}}" method="POST" >
                ...
                <div class="grid gap-4 mb-4 grid-cols-2">
                    ...
                    <button type="submit"
                    class="text-white inline-flex items-center bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center dark:bg-orange-500 dark:hover:bg-orange-400  dark:focus:ring-wite-800">
