            ...
            <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
                ...
                <div class="p-4 md:p-5">
                    ...
                    <form class="space-y-4" action="{{ route('typevents.store') }}" method="POST">
                        ...
                        <div>
                            <label for="type" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">name
                                Type
                                Event</label>
                        ...
                        <input type="submit"
                            class="w-full text-center py-2 px-3 inline-flex items-center gap-x-2 text-sm font-medium rounded-lg border border-transparent bg-[#FF7322] text-white hover:bg-[#FF6822] focus:outline-none focus:bg-[#FF6822] disabled:opacity-50 disabled:pointer-events-none" value="Enregistrement" />
                    ...
                    <td>
                        ...
                        <div id="dropdownDots{{ $i }}"
                            ...
                            <ul class="py-2 text-sm text-gray-700 dark:text-gray-200"
                                ...
                                <li>
                                    <a href="{{ route('typevents.update', $item->id) }}"
