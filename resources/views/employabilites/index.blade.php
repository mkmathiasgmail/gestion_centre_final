<x-app-layout>
    ...
    <div class="relative mt-4 overflow-x-auto">
        <table class="w-full text-sm text-left text-gray-500 rtl:text-right dark:text-gray-400 display " style="width: 100%" id="table">
            ...
            <tbody>
                ...
                <tr class="bg-white border-b dark:bg-gray-800 dark:border-gray-700">
                    ...
                    <td class="px-6 py-4">
                        <a href="#" data-id="{{ $item->id }}" onclick="supprimer(event, '{{ $item->odcuser->id }}');" data-modal-target="large-employe-modal" data-modal-toggle="large-employe-modal">
                            <svg class="w-10 h-10" xmlns=" http://www.w3.org/2000/svg" viewBox="0 0 24 24">
                                <path class="bg-teal-500 fill-current" d="M22,3H5A2,2 0 0,0 3,5V9H5V5H22V19H5V15H3V19A2,2 0 0,0 5,21H22A2,2 0 0,0 24,19V5A2,2 0 0,0 22,3M7,15V13H0V11H7V9L11,12L7,15M20,13H13V11H20V13M20,9H13V7H20V9M17,17H13V15H17V17Z" />
        ...
        <div class="flex justify-end mt-4 mb-4">
            ...
            <form method="POST" action="{{ route('importEmploye') }}" enctype="multipart/form-data" class="flex items-center w-full max-w-md">
                @csrf
                <input type="file" name="file" accept=".csv,.xls,.xlsx" required class="block w-full text-sm text-gray-900 bg-white border border-gray-300 rounded-lg focus:ring-green-500 focus:border-black dark:bg-gray-800 dark:text-gray-200 dark:border-gray-600">

                <button type="submit" class="m-5 py-2 px-3 inline-flex items-center gap-x-2 text-sm font-medium rounded-lg border border-transparent bg-[#FF7322] text-white hover:bg-[#FF6822] focus:outline-none focus:bg-[#FF6822] disabled:opacity-50 disabled:pointer-events-nonee">

                    <svg class="inline-block w-5 h-5 mr-1" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
                        <path fill="white" d="M14 2H6C4.89 2 4 2.9 4 4V20C4 21.11 4.89 22 6 22H18C19.11 22 20 21.11 20 20V8L14 2M18 20H6V4H13V9H18V20M15 11.93V19H7.93L10.05 16.88L7.22 14.05L10.05 11.22L12.88 14.05L15 11.93Z" />
                    </svg>
                    Importer
                </button>

                <a href="{{ route('exportModelEmploye') }}" class="text-sm font-medium text-gray-700 underline hover:text-[#ff7920] ml-4 flex items-center">
                    <svg class="inline-block w-5 h-5 mr-1" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
